        ...
        <div class="container">
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-Neueste" role="tabpanel" tabindex="0">
                    ...
                    <!-- blog-slide-active -->
                    <div class="mos-owl-carousel blog-slide-active owl-carousel mb-5" data-carousel-options='{"loop": true,"items": 1,"margin": 0,"autoplay": true,"nav": true,"autoplayTimeout": 2500,"animateOut": "fadeOut","smartSpeed": 2500,"dots": true,"autoplayHoverPause": true}'>
                    ...
                    <div class="blogs-post section-padding pt-0 bg-white">
                        <div class="blog-post-inner">
                            ...
                            <div class="common-btn banner-btn d-flex justify-content-center mt-5">                                                       
                                <input type="hidden" class="data" value='{"term_id":"<?php echo $term_id ?>", "tax":"<?php echo $tax ?>", count":"<?php echo $default_posts_per_page ?>", "total":"<?php echo $query->found_posts ?>"}'> 
                                <button class="btn fill-btn fw-semi-bold text-gray_1 lh-20 text-decoration-none bg-flourescent_blue radius-4" type="button">
                    ...
                    <div class="case-studies">
                        <div
                            ...
                            <a href="#"
                                class="text-lapis_lazuli text-decoration-none fw-semi-bold d-flex align-items-center gap-2">
                        ...
                        <div class="mos-owl-carousel blog-slide-active owl-carousel mb-5" data-carousel-options='{"loop": true,"items": 1,"margin": 0,"autoplay": true,"nav": true,"autoplayTimeout": 2500,"animateOut": "fadeOut","smartSpeed": 2500,"dots": true,"autoplayHoverPause": true}'>
                            <div class="single-blog">
                                <div class="featured-image">
                                    <a href="#">
                                        <img src="<?php echo get_template_directory_uri()?>/assets/img/blog-featured-img.png" alt="Featured Image"
                                            class="img-fluid w-100 radius-4">
                                    </a>
                                </div>
                                <div class="blog-info">
                                    <h6
                                        class="sub-title fs-18 fw-semi-bold text-lapis_lazuli bg-lapis_lazuli_light radius-4 d-inline-block mb-3">
                                        Dienstleistungen
                                    </h6>
                                    <h3 class="mb-4">
                                        <a href="#" class="blog-title text-gray_1 fs-4 fw-medium text-decoration-none">
                                            Worte sind die Brücke: Harmonie in Songwriting und Content-Strategie
                                            finden
                                        </a>
                                    </h3>
                                    <p class="fs-18 text-gray_2 fw-normal mb-4">
                                        Welcome Bambee customers; we are glad to have you here. Learn more about
                                        the
                                        benefits we ....
                                    </p>
                                    <div class="author d-flex gap-3 align-items-center">
                                        <div class="author-img">
                                            <img src="<?php echo get_template_directory_uri()?>/assets/img/author-img.png" alt="author img"
                                                class="img-fluid w-auto">
                                        </div>
                                        <a href="#" class="author-info d-block text-decoration-none">
                                            <p class="mb-0 text-gray_1 fs-6">Written By <b>Daniel Eskandar</b>
                                            </p>
                                            <p class="mb-0 fs-14 fw-normal text-gray_3">October 26, 2022</p>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="single-blog">
                                <div class="featured-image">
                                    <a href="#">
                                        <img src="<?php echo get_template_directory_uri()?>/assets/img/blog-details-featured-img.jpg" alt="Featured Image"
                                            class="img-fluid w-100 radius-4">
                                    </a>
                                </div>
                                <div class="blog-info">
