<?php
//Add theme setup
if ( ! function_exists( 'dartera_setup' ) ) :
	function dartera_setup() {
		...
		register_nav_menus( array(
			'mainmenu' => esc_html__('Main Menu', 'dartera'),
			'mobilemenu' => esc_html__('Mobile Menu', 'dartera'),
			'widgetmenu' => esc_html__('Widget Menu', 'dartera'),
		));
...
add_action( 'after_setup_theme', 'dartera_setup' );